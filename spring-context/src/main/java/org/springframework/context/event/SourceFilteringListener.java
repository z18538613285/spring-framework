 ...
 * @since 2.0.5
 *
 * @tips 实现 GenericApplicationListener、SmartApplicationListener 监听器，实现将原始对象触发的事件，转发给指定监听器。
 */
public class SourceFilteringListener implements GenericApplicationListener, SmartApplicationListener {
	...
	public void onApplicationEvent(ApplicationEvent event) {
		// 就是原始类 source 。如果是，则调用 #onApplicationEventInternal(ApplicationEvent event) 方法，
		// 将事件转发给 delegate 监听器。
